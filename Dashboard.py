...
root.configure(bg="#92C7CF")
Heading=LabelFrame(root,bd=2,relief="groove")
Heading.place(x=0,y=0,width=1520,height=85)
image_logo=p.Image.open("nav.png")
...
appliances_list=[]
Products_frame=LabelFrame(root,bd=0,relief="groove",text="Products",font="arial 16 bold",fg="black")
Products_frame.place(x=320,y=90,width=1180,height=680)
...
Button_frame=LabelFrame(root,bd=0,relief="groove",bg="#92C7CF")
Button_frame.place(x=10,y=100,width=300,height=490)
def save_invoice(text):
    op=messagebox.askyesno("Delivery Confirmed","Your products will be deliverd within 2-3 days.")
    if op:
        t=datetime.now()
...
def GroceryCall():
    ...
    add_grocery1=Button(lf_grocery1,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG1).place(x=60,y=245)
    add_grocery2=Button(lf_grocery2,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG2).place(x=60,y=245)
    add_grocery3=Button(lf_grocery3,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG3).place(x=60,y=245)
    add_grocery4=Button(lf_grocery4,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG4).place(x=60,y=245)
    add_grocery5=Button(lf_grocery5,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG5).place(x=60,y=245)
    add_grocery6=Button(lf_grocery6,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG6).place(x=60,y=245)
    add_grocery7=Button(lf_grocery7,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG7).place(x=60,y=245)
    add_grocery8=Button(lf_grocery8,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG8).place(x=60,y=245)
    add_grocery9=Button(lf_grocery9,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG9).place(x=60,y=245)
    add_grocery10=Button(lf_grocery10,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddG10).place(x=60,y=245)
def ElectronicsCall():
    HideAllFrames()
    lf_electronics1=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics1.place(x=50,y=35,width=200,height=280)
    lf_electronics2=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics2.place(x=270,y=35,width=200,height=280)
    lf_electronics3=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics3.place(x=490,y=35,width=200,height=280)
    lf_electronics4=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics4.place(x=710,y=35,width=200,height=280)
    lf_electronics5=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics5.place(x=935,y=35,width=200,height=280)
    lf_electronics6=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics6.place(x=50,y=330,width=200,height=280)
    lf_electronics7=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics7.place(x=270,y=330,width=200,height=280)
    lf_electronics8=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics8.place(x=490,y=330,width=200,height=280)
    lf_electronics9=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics9.place(x=710,y=330,width=200,height=280)
    lf_electronics10=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_electronics10.place(x=935,y=330,width=200,height=280)
    ...
    add_electronics1=Button(lf_electronics1,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE1).place(x=120,y=245)
    add_electronics2=Button(lf_electronics2,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE2).place(x=120,y=245)
    add_electronics3=Button(lf_electronics3,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE3).place(x=120,y=245)
    add_electronics4=Button(lf_electronics4,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE4).place(x=120,y=245)
    add_electronics5=Button(lf_electronics5,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE5).place(x=120,y=245)
    add_electronics6=Button(lf_electronics6,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE6).place(x=60,y=245)
    add_electronics7=Button(lf_electronics7,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE7).place(x=60,y=245)
    add_electronics8=Button(lf_electronics8,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE8).place(x=60,y=245)
    add_electronics9=Button(lf_electronics9,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE9).place(x=120,y=245)
    add_electronics10=Button(lf_electronics10,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddE10).place(x=60,y=245)
def SportsGymCall():
    HideAllFrames()
    lf_sportsgym1=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym1.place(x=50,y=35,width=200,height=280)
    lf_sportsgym2=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym2.place(x=270,y=35,width=200,height=280)
    lf_sportsgym3=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym3.place(x=490,y=35,width=200,height=280)
    lf_sportsgym4=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym4.place(x=710,y=35,width=200,height=280)
    lf_sportsgym5=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym5.place(x=935,y=35,width=200,height=280)
    lf_sportsgym6=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym6.place(x=50,y=330,width=200,height=280)
    lf_sportsgym7=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym7.place(x=270,y=330,width=200,height=280)
    lf_sportsgym8=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym8.place(x=490,y=330,width=200,height=280)
    lf_sportsgym9=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym9.place(x=710,y=330,width=200,height=280)
    lf_sportsgym10=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_sportsgym10.place(x=935,y=330,width=200,height=280)
    ...
    add_sportsgym1=Button(lf_sportsgym1,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS1).place(x=68,y=245)
    add_sportsgym2=Button(lf_sportsgym2,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS2).place(x=68,y=245)
    add_sportsgym3=Button(lf_sportsgym3,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS3).place(x=68,y=245)
    add_sportsgym4=Button(lf_sportsgym4,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS4).place(x=68,y=245)
    add_sportsgym5=Button(lf_sportsgym5,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS5).place(x=68,y=245)
    add_sportsgym6=Button(lf_sportsgym6,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS6).place(x=68,y=245)
    add_sportsgym7=Button(lf_sportsgym7,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS7).place(x=68,y=245)
    add_sportsgym8=Button(lf_sportsgym8,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS8).place(x=68,y=245)
    add_sportsgym9=Button(lf_sportsgym9,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS9).place(x=68,y=245)
    add_sportsgym10=Button(lf_sportsgym10,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddS10).place(x=68,y=245)
def FurnitureCall():
    HideAllFrames()
    lf_furniture1=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture1.place(x=50,y=35,width=200,height=280)
    lf_furniture2=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture2.place(x=270,y=35,width=200,height=280)
    lf_furniture3=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture3.place(x=490,y=35,width=200,height=280)
    lf_furniture4=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture4.place(x=710,y=35,width=200,height=280)
    lf_furniture5=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture5.place(x=935,y=35,width=200,height=280)
    lf_furniture6=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture6.place(x=50,y=330,width=200,height=280)
    lf_furniture7=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture7.place(x=270,y=330,width=200,height=280)
    lf_furniture8=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture8.place(x=490,y=330,width=200,height=280)
    lf_furniture9=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture9.place(x=710,y=330,width=200,height=280)
    lf_furniture10=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_furniture10.place(x=935,y=330,width=200,height=280)
    ...
    add_furniture1=Button(lf_furniture1,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF1).place(x=68,y=245)
    add_furniture2=Button(lf_furniture2,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF2).place(x=68,y=245)
    add_furniture3=Button(lf_furniture3,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF3).place(x=68,y=245)
    add_furniture4=Button(lf_furniture4,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF4).place(x=68,y=245)
    add_furniture5=Button(lf_furniture5,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF5).place(x=68,y=245)
    add_furniture6=Button(lf_furniture6,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF6).place(x=68,y=245)
    add_furniture7=Button(lf_furniture7,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF7).place(x=68,y=245)
    add_furniture8=Button(lf_furniture8,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF8).place(x=68,y=245)
    add_furniture9=Button(lf_furniture9,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF9).place(x=68,y=245)
    add_furniture10=Button(lf_furniture10,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddF10).place(x=68,y=245)
def AppliancesCall():
    HideAllFrames()
    lf_appliances1=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances1.place(x=50,y=35,width=200,height=280)
    lf_appliances2=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances2.place(x=270,y=35,width=200,height=280)
    lf_appliances3=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances3.place(x=490,y=35,width=200,height=280)
    lf_appliances4=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances4.place(x=710,y=35,width=200,height=280)
    lf_appliances5=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances5.place(x=935,y=35,width=200,height=280)
    lf_appliances6=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances6.place(x=50,y=330,width=200,height=280)
    lf_appliances7=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances7.place(x=270,y=330,width=200,height=280)
    lf_appliances8=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances8.place(x=490,y=330,width=200,height=280)
    lf_appliances9=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances9.place(x=710,y=330,width=200,height=280)
    lf_appliances10=LabelFrame(Products_frame,bd=2,relief="groove")
    lf_appliances10.place(x=935,y=330,width=200,height=280)
    ...
    add_appliances1=Button(lf_appliances1,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA1).place(x=68,y=245)
    add_appliances2=Button(lf_appliances2,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA2).place(x=68,y=245)
    add_appliances3=Button(lf_appliances3,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA3).place(x=68,y=245)
    add_appliances4=Button(lf_appliances4,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA4).place(x=68,y=245)
    add_appliances5=Button(lf_appliances5,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA5).place(x=68,y=245)
    add_appliances6=Button(lf_appliances6,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA6).place(x=68,y=245)
    add_appliances7=Button(lf_appliances7,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA7).place(x=68,y=245)
    add_appliances8=Button(lf_appliances8,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA8).place(x=68,y=245)
    add_appliances9=Button(lf_appliances9,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA9).place(x=68,y=245)
    add_appliances10=Button(lf_appliances10,text="Add Item",bg="#124076",fg="white",font="times 9 bold",command=AddA10).place(x=68,y=245)
Grocery_button=Button(Button_frame,text="Grocery",font=('Arial',16,'bold'),width=17,bd=6,bg="#124076",fg="white",command=GroceryCall)
Grocery_button.grid(row=0,column=0,padx=30,pady=10)
Electronics_button=Button(Button_frame,text="Electronics",font=('Arial',16,'bold'),width=17,bd=6,bg="#124076",fg="white",command=ElectronicsCall)
Electronics_button.grid(row=1,column=0,padx=30,pady=10)
Sports_Gym_button=Button(Button_frame,text="Sports and Gym",font=('Arial',16,'bold'),width=17,bd=6,bg="#124076",fg="white",command=SportsGymCall)
Sports_Gym_button.grid(row=2,column=0,padx=30,pady=10)
Furniture_button=Button(Button_frame,text="Furniture",font=('Arial',16,'bold'),width=17,bd=6,bg="#124076",fg="white",command=FurnitureCall)
Furniture_button.grid(row=3,column=0,padx=30,pady=10)
Appliances_button=Button(Button_frame,text="Appliances",font=('Arial',16,'bold'),width=17,bd=6,bg="#124076",fg="white",command=AppliancesCall)
Appliances_button.grid(row=4,column=0,padx=30,pady=10)
Group_button=Button(Button_frame,text="Group Shopping",font=('Arial',16,'bold'),width=17,bd=6,bg="#124076",fg="white")
Group_button.grid(row=5,column=0,padx=30,pady=10)
Social_button=Button(Button_frame,text="Social Activity",font=('Arial',16,'bold'),width=17,bd=6,bg="#124076",fg="white")
Social_button.grid(row=6,column=0,padx=30,pady=10)
def Bill():
    ...
    if op:
        ...
        if max_discount==discount[0]:
            suggest=Label(root,bd=1,text="Suggested : 15% Off upto Rs.500",font="times 12",fg="blue").place(x=600,y=480)
        elif max_discount==discount[1]:
            suggest=Label(root,bd=1,text="Suggested : 10% Off upto Rs.750",font="times 12",fg="blue").place(x=600,y=480)
        else:
            suggest=Label(root,bd=1,text="Suggested : 5% Off upto Rs.1000",font="times 12",fg="blue").place(x=600,y=480)
        def GenBill(d,choice):
            bill_area=LabelFrame(root,bd=2,relief="groove")
            bill_area.place(x=305,y=120,width=750,height=600)
            ...
            bill_txt_area.insert(END,Spaces(40)+"EMart\n"+Spaces(90,'*')+"\n")
            ...
            save_button=Button(root,text="Buy",font="times 20 bold",bd=6,bg="#124076",width=10,fg="white",command=lambda:save_invoice(bill_txt_area.get("1.0",END)))
            save_button.place(x=1120,y=600)
        Coupon_frame_2=LabelFrame(root,bd=0,relief="groove",text="Apply a Coupon",fg="Black",font="arial 16 bold").place(x=550,y=150,width=380,height=300)
        Coupon_apply1=Button(Coupon_frame_2,text="15% Off upto Rs.500",font="times 20 bold",width=17,bd=6,bg="green",fg="white",command=lambda:GenBill(discount[0],1))
        Coupon_apply1.place(x=590,y=190)
        Coupon_apply2=Button(Coupon_frame_2,text="10% Off upto Rs.750",font="times 20 bold",width=17,bd=6,bg="green",fg="white",command=lambda:GenBill(discount[1],2))
        Coupon_apply2.place(x=590,y=280)
        Coupon_apply3=Button(Coupon_frame_2,text="5% Off upto Rs.1000",font="times 20 bold",width=17,bd=6,bg="green",fg="white",command=lambda:GenBill(discount[2],3))
        Coupon_apply3.place(x=590,y=370)
    else:
        messagebox.showinfo("Bill Generation Confirmation","You can continue shopping now.")
bill_gen_button=Button(Heading,bd=2,text="Proceed to Checkout",font=('Arial',16,'bold'),bg="#6895D2",fg="white",activebackground="purple",command=Bill)
bill_gen_button.place(x=1265,y=20)
root.mainloop()